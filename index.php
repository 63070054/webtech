...
?>
    <div class="section_1">
        <div style="position: absolute; width: 100%; height: 100%;">
            <video muted autoplay preload="auto" loop="" playsinline="" data-video="0" style="height: 100%; object-fit: cover; width: 100vw; top: 0; left: 0; opacity: .5;">
                <source type="video/webm" src="./src/index/bg_video.webm">
                <source type="video/mp4" src="./src/index/bg_video.mp4">
            </video>
        </div>
        <div style="padding: 40px; height: 100%; width: fit-content; max-width: 60%; padding-left: 10%; display: flex; flex-direction: column; justify-content: center; align-content: flex-end; position: relative; z-index: 100;" data-aos="fade-right" data-aos-delay="1000" data-aos-duration="2500">
            ...
            <a href="https://store.steampowered.com/app/570/Dota_2/" target="_blank" style="height: 78px;  margin-top: 30px; width: fit-content;" class="eff-up">
                <div style="height: 100%; border-radius: 6px; border: 3px solid #ffffff90; box-shadow: 0px 0px 5px #000; display: inline-flex; flex-direction: row; align-items: center; cursor: pointer; transition-property: filter,transform,box-shadow; transition-timing-function: ease-in-out; transition-duration: .1s;">
                    <div style="background-image: url('./src/index/logo_steam.svg'); width: 48px; height: 48px; margin: 0px 8px; background-size: contain; background-repeat: no-repeat;"></div>
    ...
    <div class="section_3">
        <div style="background-size: cover; background-position: center bottom; background-repeat: no-repeat; height: 30vh; width: 100%; display: flex; flex-direction: column; align-items: center; margin-bottom: 200px;">
            <img style="width: 100%; opacity: .6; z-index: -1;" src="./src/index/bg_section3.jpg">
    ...
    <div class="section_4">
        ...
        <div style="width: 80%; z-index: 3; min-height: 0; display: flex; flex-direction: column; position: relative; overflow: hidden; height: 690px;">
            <img src="./src/index/hero_grid.jpeg" style="width: 100%; height: 100%; object-fit: none;">
        </div>
    </div>

    <div class="section_5" style="background-image: url('./src/index/bg_section5.jpg');">
        <div style="width: 100%; height: calc(100% - 50px); position: absolute; overflow: hidden;">
            <img style="max-width: 20%; left: 100px; position: absolute; z-index: 100; box-shadow: 0px 0px 30px #000;" src="./src/index/section5_pop_up_1.jpg" data-aos="fade-up" data-aos-delay="300" data-aos-duration="2500">
            <img style="top: 200px; right: -50px; max-width: 30%; position: absolute; z-index: 100; box-shadow: 0px 0px 30px #000;" src="./src/index/section5_pop_up_2.jpg" data-aos="fade-up" data-aos-delay="600" data-aos-duration="2500">
            <img style="max-width: 25%; left: -100px; bottom: 250px;position: absolute; z-index: 100; box-shadow: 0px 0px 30px #000;" src="./src/index/section5_pop_up_3.jpg" data-aos="fade-up" data-aos-delay="1000" data-aos-duration="2500">
        </div>
        <div style="background-image: url('./src/index/logo_dpc.svg'); background-size: cover; background-repeat: no-repeat; min-width: 96px; min-height: 96px; margin-top: 550px;"></div>
    ...
    <div class="section_6" style="background-image: url('./src/index/bg_section6.png');">
